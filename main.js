...
if (colorUser != null) {
    ...
    document.getElementsByName("h3").style.color = colorUser;
    ...
    document.getElementById("sosimple").className = "row sosimple_"+nameUser;
    document.getElementById("musicforward").className = "musicforward_"+nameUser;
}
